            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive">
                         ...
                         <form enctype="multipart/form-data" action="/../Haber_Ekleniyor.php" method="post" class="haber-ekle">
                        Başlık<br><br>
                        <input autofocus class="baslik" width="500px" type="text" name="title" maxlength="90"> <br><br>
                        Özet<br><br>
                        <textarea class="ozet" placeholder="Buraya yazacağınız metin, Ana sayfada gözüken kısımdır." maxlength="200" name="summary"></textarea><br><br>
                        Kategori<br><br>
                        <input autofocus class="baslik" width="500px" type="text" name="category"> <br><br>
                        İçerik<br><br>
                        <textarea class="icerik" placeholder="Haberinizi bu kısıma yazınız."maxlength="5000" name="content"></textarea><br><br>
                        Haber Thumbnail<br><br>
                        <input id="real-file" name="dosya" type="file" hidden="hidden"><br><br>
                        <button type="button" id="custom-button">Resim Seç</button>
