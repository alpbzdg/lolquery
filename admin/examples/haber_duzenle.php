...
$writer = $_SESSION["admin_mail"];
    if($_SESSION["admin_online"]){
        $haber_id = $_GET["id"];
            ...
            $haber_bul_sorgu ="SELECT * FROM news WHERE id ='$haber_id'";
            
                $haber_bul = mysqli_query($baglan, $haber_bul_sorgu);    
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive">
                         ...
                         <form method="post" class="haber-ekle">
                        Başlık<br><br>
                        <input autofocus class="baslik" width="500px" type="text" name="title" maxlength="90" value="<?php echo $title;?>"> <br><br>
                        Özet<br><br>
                        <textarea class="ozet" maxlength="200" name="summary"><?php echo $ozet;?></textarea><br><br>
                        Kategori<br><br>
                        <input autofocus class="baslik" value="<?php echo $kategori;?>" width="500px" type="text" name="category"> <br><br>
                        İçerik<br><br>
                        <textarea class="icerik" maxlength="5000" name="content"><?php echo $yazi;?></textarea><br><br>
...
$summary = sef_link($_POST["summary"]);
...
function sef_link($baslik)
{
    ...
    $haber_guncelle = "UPDATE news SET yazi = '$content' ozet = '$summary' baslik = '$title' kategori='$category' link = '$link' where id = '$haber_id'";

                          $sorgu_yap = mysqli_query($baglan, $haber_guncelle);
                          
                          if($sorgu_yap){
                              header("Location: http://lolquery.codingtr.com/admin/examples/haberler.php");
                          }else{
