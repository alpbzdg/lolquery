  ...
  <div class="content">
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title"> Onay Bekleyen Oyuncular</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table tablesorter " id="">
                    <thead class=" text-primary">
                      ...
                      <tr>
                        ...
                        <th style="position:absolute;margin-left:5px;">
                          Server
                        </th>
                    ...
                    <tbody>
                         ...
                         $sorgu = "SELECT * FROM game_users WHERE onay = 2";
    ...
    ?>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php echo "<a target='_blank' onClick='' href='onay.php?mail={$oyuncu_goster['user_email']}'><i class='far fa-check-circle fa-2x'></i></a>";?>
                        </td>
